...
<div class="header-outs" id="home">
    <div class="header-bar">
        ...
        <div class="hedder-up">
            <h1><a class="navbar-brand" href="#">Makita - Maktec <span class="fa fa-lightbulb-o"
...
<div class="about" id="gis">
    ...
    <div class="container-fluid">
        <div class="row abt-colm offset">
            ...
            $query = $koneksi->query("SELECT * from tbl_gis"); //memanggil data dari database
            $tampils = array(); //deklarasi array
            while ($tampil = $query->fetch_assoc()) {
                $tampils[] = $tampil; //memasukkan data ke array
            }
            $data = json_encode(array('results' => $tampils)); //membuat data ke sebuah JSON
            ?>

            <!-- JS untuk maps dan jarak -->
