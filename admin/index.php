...
?>
<?php
error_reporting(0); //menghilangkan error notice
if (!empty($_SESSION['level'])) { //jika session tidak kosong maka menampilkan data dibawah
    ?>
    ...
    <div class="wrapper">
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="?m1=admin&m2=admin"><i class="fa fa-circle-o"></i> Admin</a>
                                </li>
                                <li class="active"><a href="?m1=gis&m2=gis"><i class="fa fa-circle-o"></i> Data Gis</a>
                                </li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    if (empty($_GET['m1']) || empty($_GET['m2'])) //untuk menampilkan kontent
                    {
                        include "beranda.php"; //jika parameter diatas kosong
                    } else {
                        include "konten/" . $_GET['m1'] . "/" . $_GET['m2'] . ".php"; //jika parameter diatas tidak kosong
                    }
                    ?>
                </section>
                <!-- /.Left col -->
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2018 | Rizky.</strong> All rights
            reserved.
        </footer>
    ...
    include "login.php"; //jika session kosong maka menampilkan login
}
?>